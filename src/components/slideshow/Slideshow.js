      ...
      >
        ...
        <div className="slider__nav">
          ...
          <div className="slider__nav-dots" id="slider-dots">
            <div className="slider__nav-dot slider__nav-dot--active" data-id="1" />
            <div className="slider__nav-dot" data-id="2" />
            <div className="slider__nav-dot" data-id="3" />
            <div className="slider__nav-dot" data-id="4" />
            <div className="slider__nav-dot" data-id="5" />
          </div>
        </div>
      </div>
    </div>
